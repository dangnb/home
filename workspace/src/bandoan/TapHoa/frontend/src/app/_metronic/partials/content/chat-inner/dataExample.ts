...
const defaultMessages: Array<MessageModel> = [
  ...
  },
  {
    user: 2,
    type: 'out',
    text: 'Hey there, weâ€™re just writing to let you know that youâ€™ve been subscribed to a repository on GitHub.',
    time: '5 mins',
  },
  {
    user: 4,
  ...
  },
  {
    user: 2,
    type: 'out',
    text: 'Youâ€™ll receive notifications for all issues, pull requests!',
    time: '2 Hours',
  },
  {
    user: 4,
...
export type { MessageModel, UserInfoModel };
