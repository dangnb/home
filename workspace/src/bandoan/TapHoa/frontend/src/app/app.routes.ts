...
export const routes: Routes = [
    ...
    },
    {
        ...
        children: [
            ...
            { path: 'products/create', loadComponent: () => import('./admin/products/product-form/product-form.component').then(m => m.ProductFormComponent) },
            { path: 'products/low-stock', loadComponent: () => import('./admin/products/low-stock/low-stock.component').then(m => m.LowStockComponent) },
            { path: 'products/:id', loadComponent: () => import('./admin/products/product-form/product-form.component').then(m => m.ProductFormComponent) },
