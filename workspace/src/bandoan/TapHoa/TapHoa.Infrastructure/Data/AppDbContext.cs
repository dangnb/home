...
public class AppDbContext : DbContext, TapHoa.Application.Interfaces.IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Category>().HasData(
            new { Id = Guid.Parse("01950000-0000-7000-8000-000000001001"), Name = "Trái cây", Slug = "trai-cay", Description = "Hoa quả tươi các loại", Icon = "🍎", ParentId = (Guid?)null, CreatedDate = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc), IsDeleted = false, CompanyId = companyId },
            new { Id = Guid.Parse("01950000-0000-7000-8000-000000001002"), Name = "Rau củ", Slug = "rau-cu", Description = "Rau củ sạch nông trại", Icon = "🥬", ParentId = (Guid?)null, CreatedDate = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc), IsDeleted = false, CompanyId = companyId },
            new { Id = Guid.Parse("01950000-0000-7000-8000-000000001003"), Name = "Thịt cá", Slug = "thit-ca", Description = "Thịt tươi sống và hải sản", Icon = "🥩", ParentId = (Guid?)null, CreatedDate = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc), IsDeleted = false, CompanyId = companyId }
        );

        modelBuilder.Entity<Product>().HasData(
            new { Id = Guid.Parse("01950000-0000-7000-8000-000000002001"), Name = "Táo New Zealand size to", Slug = "tao-new-zealand-size-to", CategoryId = Guid.Parse("01950000-0000-7000-8000-000000001001"), CostPrice = 50000m, WholesalePrice = 70000m, Price = 75000m, StockQuantity = 150, MinStockLevel = 10, MaxStockLevel = 200, Unit = "kg", Status = ProductStatus.Active, MainImageUrl = (string?)null, AdditionalImages = new List<string>(), CreatedDate = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc), IsDeleted = false, CompanyId = companyId },
            new { Id = Guid.Parse("01950000-0000-7000-8000-000000002002"), Name = "Rau cải thìa hữu cơ", Slug = "rau-cai-thia-huu-co", CategoryId = Guid.Parse("01950000-0000-7000-8000-000000001002"), CostPrice = 8000m, WholesalePrice = 12000m, Price = 15000m, StockQuantity = 30, MinStockLevel = 0, MaxStockLevel = 0, Unit = "bó", Status = ProductStatus.Active, MainImageUrl = (string?)null, AdditionalImages = new List<string>(), CreatedDate = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc), IsDeleted = false, CompanyId = companyId },
            new { Id = Guid.Parse("01950000-0000-7000-8000-000000002003"), Name = "Thịt bò thăn Úc tươi sạch", Slug = "thit-bo-than-uc-tuoi-sach", CategoryId = Guid.Parse("01950000-0000-7000-8000-000000001003"), CostPrice = 250000m, WholesalePrice = 330000m, Price = 350000m, StockQuantity = 5, MinStockLevel = 10, MaxStockLevel = 50, Unit = "kg", Status = ProductStatus.OutOfStock, MainImageUrl = (string?)null, AdditionalImages = new List<string>(), CreatedDate = new DateTime(2025, 1, 1, 0, 0, 0, DateTimeKind.Utc), IsDeleted = false, CompanyId = companyId }
        );
    }
}
