...
public class EmployeeProfileConfiguration : IEntityTypeConfiguration<EmployeeProfile>
{
    public void Configure(EntityTypeBuilder<EmployeeProfile> builder)
    {
        ...
        builder.Property(e => e.SocialInsuranceNumber).HasColumnName("social_insurance_number").HasMaxLength(50);
        builder.Property(e => e.BankAccountNumber).HasColumnName("bank_account_number").HasMaxLength(50);
        builder.Property(e => e.BankName).HasColumnName("bank_name").HasMaxLength(150);
        builder.Property(e => e.BankBranch).HasColumnName("bank_branch").HasMaxLength(150);
        builder.Property(e => e.PermanentAddress).HasColumnName("permanent_address").HasMaxLength(255);
        builder.Property(e => e.TemporaryAddress).HasColumnName("temporary_address").HasMaxLength(255);
        builder.Property(e => e.EmergencyContactName).HasColumnName("emergency_contact_name").HasMaxLength(150);
        builder.Property(e => e.EmergencyContactPhone).HasColumnName("emergency_contact_phone").HasMaxLength(50);
        ...
        builder.Property(e => e.OfficialJoinedDate).HasColumnName("official_joined_date");
